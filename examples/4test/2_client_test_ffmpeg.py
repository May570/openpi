...
def main():
    ...
    ap.add_argument("--prompt", default="Grasp the roller for smoothing materials firmly from the table.")
    ap.add_argument("--timeout-s", type=int, default=100)
    ap.add_argument("--sleep-s", type=float, default=0.0, help="每帧请求后 sleep，用于限速")
    ap.add_argument("--fps", type=int, default=10, help="输出 cam_high 视频帧率")
