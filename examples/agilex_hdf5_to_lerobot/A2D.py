...
from scripts.agilex_hdf5_to_lerobot.A2D_to_lerobot import port_A2D, DatasetConfig

def main():
    # 配置参数
    base_dir = Path("/share/project/caomingyu/a2d_data")
    repo_id = "tasks/banana"
    ...
    try:
        ds1 = port_A2D(
            raw_dir=base_dir,
            repo_id=repo_id,
            task = "Put the banana in the basket_L.",
            start = 675,
            end = 750,
            mode="image",
