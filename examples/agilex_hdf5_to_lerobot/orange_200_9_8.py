...
from orange_200_9_8_to_lerobot import port_multiple_tasks, DatasetConfig

def main():
    # 配置参数
    base_dir = Path("/share/project/section/task/agilex_5_task_5_hdf5")
    repo_id = "agilex_5_task_5"
