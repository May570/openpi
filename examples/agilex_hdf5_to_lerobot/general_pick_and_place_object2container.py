...
def main():
    ...
    print(f"开始转换general_pick_and_place_object2container任务数据集...")
    print(f"基础目录: {base_dir}")
    print(f"数据集ID: {repo_id}")
    
    try:

        task_dir = base_dir / "general_pick_and_place_object2container"
        sub_prompt_map = {
            "general_pick_and_place_object2container": "Pick up an object and place it into a container.",
        }
