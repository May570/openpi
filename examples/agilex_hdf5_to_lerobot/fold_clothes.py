...
from scripts.agilex_hdf5_to_lerobot.to_lerobot import port_multiple_tasks, port_task_with_subtasks, DatasetConfig
...
def main():
    ...
    print(f"开始转换fold_clothes任务数据集...")
    print(f"基础目录: {base_dir}")
    print(f"数据集ID: {repo_id}")
    
    try:

        task_dir = base_dir / "fold_clothes"
        sub_prompt_map = {
            "白色短袖": "Fold the white T-shirt and place it on the tray in the top-left corner.",
            "黑色短袖": "Fold the black T-shirt and place it on the tray in the top-left corner.",
            "儿童牛仔短裤": "Fold the kids' denim shorts and place them on the tray in the top-left corner.",
            "卡其色牛仔裤": "Fold the khaki jeans and place them on the tray in the top-left corner.",
        }
