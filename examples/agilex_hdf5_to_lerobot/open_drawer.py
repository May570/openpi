...
def main():
    ...
    print(f"开始转换open_drawer任务数据集...")
    print(f"基础目录: {base_dir}")
    print(f"数据集ID: {repo_id}")
    
    try:

        task_dir = base_dir / "open_drawer"
        sub_prompt_map = {
            "黑色桌布": "Open the drawer on the black table.",
            "卡其色桌布": "Open the drawer on the khaki table.",
            "深绿桌布": "Open the drawer on the dark green table.",
            "原本颜色": "Open the drawer on the plain table.",
            "枣红桌布": "Open the drawer on the maroon table.",
        }
