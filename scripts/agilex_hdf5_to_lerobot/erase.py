...
def main():
    ...
    print(f"开始转换erase任务数据集...")
    print(f"基础目录: {base_dir}")
    print(f"数据集ID: {repo_id}")
    
    try:

        task_dir = base_dir / "erase"
        sub_prompt_map = {
            "右手": "Use your right hand to erase the marks on the whiteboard.",
            "右手递左手": "Pass the eraser from your right hand to your left hand, then erase the marks on the whiteboard.",
            "左手": "Use your left hand to erase the marks on the whiteboard.",
            "左手递右手": "Pass the eraser from your left hand to your right hand, then erase the marks on the whiteboard.",
        }
