...
# 加载模型
MODEL_PATH = "/share/project/wujiling/openpi/checkpoints/pi0_drawer_open_close/pi0_drawer_open_close/10000"
...
def load_policy():
    ...
    try:
        ...
        # 使用openpi的配置和策略
        config = _config.get_config("pi0_drawer_open_close")
...
def service_info():
    ...
    return jsonify({
        ...
        "model_info": {
            ...
            "model_type": "pi0_drawer_open_close"
        },
        "timestamp": time.time()
    })
