...
class TaskTester:
    ...
    def __init__(self, service_url="http://127.0.0.1:5003", data_file="/share/project/wujiling/openpi/datasets/tasks/drawer_open_close/data/chunk-000/episode_000012.parquet", test_interval=50, output_file="all_inference_results.json", predicted_actions_file="predicted_actions.npy", true_actions_file="true_actions.npy"):
    ...
    def _build_test_data_from_row(self, row_data, row_index):
        ...
        try:
            ...
            test_data = {
                ...
                "images": images,
                "prompt": "Close the drawer on the dark green table."
            }
...
def main():
    ...
    parser.add_argument(
        "--data-file",
        default="/share/project/wujiling/openpi/datasets/tasks/drawer_open_close/data/chunk-000/episode_000012.parquet",
        help="数据文件路径"
    )
    parser.add_argument(
        "--save-data",
