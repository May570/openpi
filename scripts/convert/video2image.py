...
from scripts.convert.video_lerobot_to_image_lerobot import port_image, DatasetConfig

def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description="转换 video 数据集（支持 resume / skip）"
    )
    parser.add_argument(
        "--resume",
        action="store_true",
...
def main(argv=None):
    ...
    # 配置参数
    base_dir = Path("/share/project/wujiling/raw_datasets/bridge_orig_lerobot")
